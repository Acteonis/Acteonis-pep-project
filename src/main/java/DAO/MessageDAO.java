...
public class MessageDAO {
    ...
    */
    ...
    public Message addMessage(Model.Message message){
        ...
        try{
            ...
            if(pkResultSet.next()){
                int generated_message_id = (int) pkResultSet.getInt(1);
                return new Message(
                        generated_message_id, message.getPosted_by(), message.getMessage_text(), message.getTime_posted_epoch());
            }
